...
// recorrido en profundidad de una componente conexa grafo
...
// o fuertemente conexa(GD) en profundidad a partir de un vertice de la misma.
    ...
    //interfaz para recorrer la componente conexa(GN) o Fuertemente conexa (GD) un grafo
    ...
    // Para  recorrer todos los vertices del grafo, recorriendo cada componente conexa(GN)
    // o fuertemente conexa(GD) en amplitud a partir de un vertice de la misma.
